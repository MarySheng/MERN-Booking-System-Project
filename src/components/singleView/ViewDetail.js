...
const ViewDetail = ({setDeletedMovie, authUser}) => {
    let { id } = useParams();
                    ...
                    isLoading ?
                        ...
                        <div className="col-12 col-md-6">
                            ...
                            <div className="row mt-3">
                                        {/* Book Now
                                <Link id="bookNow" onClick={onBooking} className="btn btn-success btn-sm w-25 mr-3">Book Now</Link> */}
                                {/* Edit */} 
                                <Link id="back" to="/movies" className="btn btn-warning btn-sm w-25 mr-3">
